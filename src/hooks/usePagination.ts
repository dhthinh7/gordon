  ...
  const pagination = useMemo(() => {
    ...
    */
    if (!shouldShowLeftDots && shouldShowRightDots) {
      ...
      return { paginationRange: [...leftRange, DOTS, totalPageCount], entriesInfo, startIndex, endIndex, totalPageCount }
    }
    ...
    */
    if (shouldShowLeftDots && !shouldShowRightDots) {
      ...
      return { paginationRange: [firstPageIndex, DOTS, ...rightRange], entriesInfo, startIndex, endIndex, totalPageCount }
    }
    ...
    */
    if (shouldShowLeftDots && shouldShowRightDots) {
      ...
      return { paginationRange: [firstPageIndex, DOTS, ...middleRange, DOTS, lastPageIndex], entriesInfo, startIndex, endIndex, totalPageCount }
    }
